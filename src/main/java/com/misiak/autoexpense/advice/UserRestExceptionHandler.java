...
public class UserRestExceptionHandler {
    ...
    public ResponseEntity<UserErrorResponse> handleException(UserNotFoundException exception) {
        UserErrorResponse errorResponse = new UserErrorResponse("User not found with id: " + exception.getId(), HttpStatus.NOT_FOUND.value(), new Timestamp(System.currentTimeMillis()));
